    ...
    <section class="bg-indigo-500">
      <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
          ...
          Deleniti, earum consectetur illo sit repudiandae eos ab quas distinctio, optio dolorum mollitia unde culpa laboriosam est impedit error perspiciatis excepturi praesentium?
          </p>
          <a
            href="#"
